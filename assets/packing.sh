...
curl -X POST --data-urlencode 'input@main.js' https://javascript-minifier.com/raw > main.min.js
curl -X POST --data-urlencode 'input@main.css' https://cssminifier.com/raw > main.min.css
